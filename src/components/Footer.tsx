const Footer = () => {
  return (
    <footer>
      <div className="mx-auto flex flex-col h-full items-center p-12 ">
        <div className="flex space-x-8  z-10 mb-4">
          <a
            href="https://github.com/AbuHejleh"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/abdel-rahman-abu-hejleh-0a28a5184"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
        ...
        <div className="flex flex-col md:flex-row space-x-2">
          ...
          <a
            ...
            target="_blank"
            className="text-xs text-textColorSecondary hover:text-textColorTertiary text-center z-10"
          >
